      ...
      if (classData) {
        ...
        if (lessonData) {
          const dbLesson = {
            ...
            learningOutcomes:
              typeof lessonData.learning_outcomes === "string"
                ? JSON.parse(lessonData.learning_outcomes)
                : lessonData.learning_outcomes || [],
            keyConcepts:
              typeof lessonData.key_concepts === "string"
                ? JSON.parse(lessonData.key_concepts)
                : lessonData.key_concepts || [],
            commonMisconceptions:
              typeof lessonData.misconceptions === "string"
                ? JSON.parse(lessonData.misconceptions)
                : lessonData.misconceptions || [],
          ...
          const dbQuestions = lessonData.quiz_questions
            ? typeof lessonData.quiz_questions === "string"
              ? JSON.parse(lessonData.quiz_questions)
