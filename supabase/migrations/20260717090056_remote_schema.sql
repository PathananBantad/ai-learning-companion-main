ALTER TABLE public.quiz_results ALTER COLUMN student_id TYPE text USING student_id::text;
ALTER TABLE public.quiz_results DROP CONSTRAINT quiz_results_student_id_fkey;
...
ALTER TABLE public.quiz_results ADD COLUMN name text;
ALTER TABLE public.quiz_results ADD COLUMN class_code text;
